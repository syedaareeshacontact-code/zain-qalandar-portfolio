    ...
    <div className="architecture" aria-hidden="true">
      ...
      <svg viewBox="0 0 460 410" fill="none" className="architecture-drawing">
        <defs>
          ...
          <linearGradient id="interface-plane" x1="70" y1="70" x2="370" y2="230" gradientUnits="userSpaceOnUse"><stop stopColor="#40523a" /><stop offset="1" stopColor="#25372a" /></linearGradient>
        </defs>
        <rect x="16" y="16" width="428" height="365" fill="url(#architecture-grid)" />
        <ellipse cx="230" cy="345" rx="154" ry="27" fill="#000000" opacity=".16" />
        <path d="M230 30V360" stroke="#657b60" strokeDasharray="3 5" />
        <g className="architecture-layer layer-data" strokeLinejoin="round">
          <path d="M230 204L395 280L230 356L65 280Z" fill="#19251d" stroke="#455840" />
          <path d="M65 280V291L230 367L395 291V280M230 356V367" stroke="#455840" />
          <path d="M230 226L351 281L230 336L109 281Z" stroke="#657b60" strokeDasharray="3 5" />
          <text x="230" y="330" textAnchor="middle" fill="var(--text-muted)">{design.architectureLayers[2]}</text>
        </g>
        <g className="architecture-layer layer-application" strokeLinejoin="round">
          <path d="M230 128L395 204L230 280L65 204Z" fill="#213025" stroke="#a0b78e" />
          <path d="M65 204V216L230 292L395 216V204M230 280V292" stroke="#a0b78e" />
          <path d="M230 155L337 204L230 253L123 204Z" stroke="#a0b78e" strokeOpacity=".45" />
          <text x="230" y="254" textAnchor="middle" fill="var(--accent)">{design.architectureLayers[1]}</text>
        </g>
        <g className="architecture-layer layer-interface" strokeLinejoin="round">
          ...
          <path d="M65 128V140L230 216L395 140V128M230 204V216" stroke="#a0b78e" />
        ...
        <path d="M31 41V25H47M413 25H429V41M31 355V371H47M413 371H429V355" stroke="#455840" />
      </svg>
